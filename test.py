from sced import SimulateDatasetsMB, DualCriterionSigPanels

n_repeats = 100
n_points = 18
n_patients = 6

df = SimulateDatasetsMB(n_repeats, n_patients, n_points, effect_size=2.0, ar=0.2, min_baseline=5, min_phase=5)
